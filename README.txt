...
2) Check that the following Modules installed and enabled.
		* Search Module from drupal
    		* Library API from drupal
   If not enable it before continuing to install drupal module.

3) Download OpenSearchServer drupal module from the http://drupal.org/sandbox/ekeller/1128202 and
   unpack it in <Your-drupal-installation>/sites/all/modules/

4) Download the OpenSearchServer PHP library from the OpenSearhServer sourceforge website http://sourceforge.net/projects/opensearchserve/
   and unpack it in< Your-drupal-installation>/sites/all/libraries/
